                        ...
                        <div class="row marbot10">
                            <div class="clearfix">
                                <div class="col-md-6 col-sm-6 fadeInRight animated" data-id='1'>
                                    <a href="images/square01.jpg" data-toggle="lightbox" data-gallery="about-gallery" data-title="Eyecare Services" data-footer=" LASIK & PRK surgery, eye exams, vision testing for glasses and contacts">
                                        <div class="grid image-effect2 marbot30">
                                            <figure>
                                                <img src="images/square01.jpg" alt=" " class="img-responsive fullwidth">
                                ...
                                <div class="col-md-6 col-sm-6 fadeInRight animated" data-id='2'>
                                    <a href="images/square02.jpg" data-toggle="lightbox" data-gallery="about-gallery" data-title="Our Mission" data-footer="Clear Eye care services to everyone with affordable expense">
                                        <div class="grid image-effect2 marbot30">
                                            <figure>
                                                <img src="images/square02.jpg" alt=" " class="img-responsive fullwidth">
                                                <figcaption><i class="fa flaticon-symbols-1 gallery-icon transition"></i></figcaption>
                                            </figure>
                                        </div>
                                    </a>                    </div>
                            ...
                            <div class="clearfix">
                                <div class="col-md-6 col-sm-6 fadeInRight animated" data-id='3'>
                                    <a href="images/square03.jpg" data-toggle="lightbox" data-gallery="about-gallery" data-title="Our Vision" data-footer="Every Life on earth has a right to see this world, there are so many colors, so many beautiful lights, beautiful nature scene to see and enjoy the experience">
                                        <div class="grid image-effect2 marbot30">
                                            <figure>
                                                <img src="images/square03.jpg" alt=" " class="img-responsive fullwidth">
                                                <figcaption><i class="fa flaticon-symbols-1 gallery-icon transition"></i></figcaption>
                                            </figure>
                                        </div>
                                    </a>                    </div>
                                ...
                                <div class="col-md-6 col-sm-6 fadeInRight animated" data-id='4'>
                                    <a href="images/square04.jpg" data-toggle="lightbox" data-gallery="about-gallery" data-title="Specialized in Eyecare Services" data-footer="We have specialized doctors and specialized technology which can be customized to suit your unique eye needs.">
                                        <div class="grid image-effect2 marbot30">
                                            <figure>
                                                <img src="images/square04.jpg" alt=" " class="img-responsive fullwidth">
                                                <figcaption><i class="fa flaticon-symbols-1 gallery-icon transition"></i></figcaption>
                                            </figure>
                                        </div>
                                    </a>                    </div>
